---
id: Data_structures_and_algorithms_with_python_Experiment_02_A
title: Implement an ADT and Compute space and time complexities.
sidebar_label: A
slug: /fourth-semester/data-structures-and-algorithms-with-python/experiment-2/a
...
<iframe width="100%" height="300px" src="https://www.youtube.com/embed/yzNOhldYSBI" title="Python :Find Pair with Given Sum" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
