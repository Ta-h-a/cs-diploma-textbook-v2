---
id: Data_structures_and_algorithms_with_python_Experiment_01_B
title: Implement an ADT with all its Operations
sidebar_label: B
slug: /fourth-semester/data-structures-and-algorithms-with-python/experiment-1/b
...
<iframe width="100%" height="300px" src="https://www.youtube.com/embed/aCVpMz7_gn8" title="What is Stack Explained in Hindi l Data Structure" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

## Reference

- [Stack using Linked List](https://www.studytonight.com/data-structures/stack-using-linked-list)
