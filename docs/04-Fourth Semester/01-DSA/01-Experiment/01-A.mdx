---
id: Data_structures_and_algorithms_with_python_Experiment_01_A
title: Python program to Use and demonstrate basic data structures
sidebar_label: A
slug: /fourth-semester/data-structures-and-algorithms-with-python/experiment-1/a
description: This experiment is a collection of four programs- one that performs mathematical operations, one that manipulates strings, one that manipulates lists, and one that manipulates dictionaries. The programs demonstrate various operations such as addition, subtraction, multiplication, division, printing, appending, popping, deleting, and modifying elements in a list and dictionary.
---
...
This experiment is a collection of four programs: one that performs mathematical operations, one that manipulates strings, one that manipulates lists, and one that manipulates dictionaries. The programs demonstrate various operations such as addition, subtraction, multiplication, division, printing, appending, popping, deleting, and modifying elements in a list and dictionary.
...
- [Calculator using Python](https://www.geeksforgeeks.org/make-simple-calculator-using-python/)
- [Calculator Example](https://www.programiz.com/python-programming/examples/calculator)
