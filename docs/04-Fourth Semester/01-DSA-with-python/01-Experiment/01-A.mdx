...
<iframe width="711" height="355" src="https://www.youtube.com/embed/C_XRxLPGbUw" title="Lec-21: Python List Operations | Slicing, Membership, Repetition, Concat with examples" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
