...
<iframe width="100%" height="300px" src="https://www.youtube.com/embed/C46QfTjVCNU" title="7.1 Linear Search Algorithm | Linear Search in C | Data Structures Tutorials" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
